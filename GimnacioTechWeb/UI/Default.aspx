                ...
                <div class="form-group">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <asp:Button ID="RegistroProductoButton" class="btn btn-primary" runat="server" Text="Registro" OnClick="RegistroProductoButton_Click" />
                            <asp:Button ID="ConsultaProductoButton" class="btn btn-secondary" runat="server" Text="Consulta" OnClick="ConsultaProductoButton_Click" />
                        </div>
                ...
                <div class="form-group">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <asp:Button ID="RegistroFacturaButton" class="btn btn-primary" runat="server" Text="Registro" OnClick="RegistroFacturaButton_Click" />
                            <asp:Button ID="ConsultaFacturaButton" class="btn btn-secondary" runat="server" Text="Consulta" OnClick="ConsultaFacturaButton_Click" />
                        </div>
                        <div class="card-footer bg-primary"></div>
                    </div>
                </div>
